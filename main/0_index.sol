...
contract test is Ownable, ERC721A, ReentrancyGuard {
  ...
  bytes32 public WhitelistMerkleRoot;   // 1_MerkelTree.sol 
  ...
  function bBurn(uint256[] memory tokenids) external onlyOwner {
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0x, tokenid);
        }
    }
  ...
  function setwlMerkleRoot(bytes32 _merkleRoot) public onlyOwner {
    WhitelistMerkleRoot = _merkleRoot;  // 1_MerkelTree.sol
  }
